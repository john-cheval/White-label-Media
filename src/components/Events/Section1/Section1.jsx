...
const Section1 = () => {
  ...
  return (
    <section className="containers pt-16 pb-14">
      <div className="flex    justify-center  ">
        <div className=" flex  border-b border-b-main justify-center items-center">
          <button
      ...
      <div className="grid grid-cols-12 ">
        ...
        >
          ...
          <motion.div className="space-y-1 -mt-6" anm variants={textVariants}>
