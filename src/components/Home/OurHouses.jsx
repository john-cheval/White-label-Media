    ...
    <section className="bg-main containers pb-7 md:pb-10 lg:pb-14">
      <div className="bg-white text-main">
        ...
        <div className="grid grid-cols-12">
          <div className="col-span-12 md:col-span-5 border border-b-1 border-r-0 border-t-0 border-l-0 xl:py-16 xl:px-14 xl:space-y-20  2xl:py-24 2xl:pl-24 2xl:pr-16 2xl:space-y-28 lg: py-14 lg:px-10 md:space-y-10 lg:space-y-14 pt-8 pb-12 px-8">
            <h5 className="main-heading text-center md:text-left mb-2 md:mb-0">
              Our Houses
            </h5>
            <p className="font-gt text-center md:text-left leading-[141%] text-3xl md:text-4xl lg:text-[40px] mb-5 md:mb-0">
              Discover our unique and specialised agencies
            </p>

            <div className="flex items-center justify-center md:justify-between group">
              <Link
                href={"/about"}
          ...
          <div className="col-span-12 md:col-span-7 grid grid-cols-1 sm:grid-cols-2 mx-auto- sm:mx-0">
            {houseData?.slice(0, 4)?.map((house, index) => (
              <div
                ...
                } pt-10 lg:pt-14 pb-10 px-6 lg:px-12 flex flex-col group  `}
              >
          ...
          <div className="col-span-12 md:col-span-8 lg:col-span-7 grid grid-cols-1 sm:grid-cols-2">
            {houseData?.slice(0, 4)?.map((house, index) => (
              <div
                ...
                } pt-10 lg:pt-14 pb-10 px-6 lg:px-12 flex flex-col  group min-h-[300px]`}
              >
                <div className="max-w-[250px] max-h-[150px] overflow-hidden mx-auto sm:mx-0 ">
                  <Image
                    src={house?.image}
