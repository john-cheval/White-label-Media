    ...
    <section className="containers text-[#EAE4D6] bg-main py-8 md:py-10 xl:py-16 2xl:py-20 3xl:py-24 bg-service ">
      <div className="grid grid-cols-12 gap-x-5">
        ...
        >
          ...
          >
            <p className="text-base md:text-xl lg:text-2xl 3xl:text-3xl leading-[190%] text-center sm:text-left">
        ...
        <div className="space-y-9 overflow-y-auto- pt-14 md:pt-0 col-span-12 md:col-span-5 bg-service-1">
          {[...services, ...services]?.map((service, index) => (
            ...
            >
              ...
              <p className="font-switzer text-sm md:text-base text-center md:text-left  leading-[161%]">
                {service?.description}
              </p>
            </motion.div>
          ))}
