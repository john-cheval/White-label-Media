          ...
          return (
            ...
            >
              ...
              >
                <motion.h4
                  variants={fadeInUp}
                  className="text-[#EAE4D6] text-xl  lg:text-2xl 3xl:text-3xl text-center md:text-left font-semibold font-switzer leading-[141%]  "
                >
                  {service?.title}
                </motion.h4>
        ...
        >
          {services[4]?.image && isVideo(services[4]?.image?.url) ? (
            <video
              ...
              muted
              loop
              src={services[4]?.image?.url}
              className="w-full h-full object-cover- "
            />
          ) : (
            <Image
              src={services[4]?.image?.url}
              alt={services[4]?.title || "Image-Services"}
              sizes="100vw"
              height={450}
              width={500}
